  ...
  return (
    <div>
        <main>
            ...
            <button className="TN bg-black text-white font-semibold py-4 mt-8 px-8 flex z-50 hover:border-2 hover:bg-transparent hover:text-black hover:border-black hover:py-4 hover:px-8 block mx-auto mb-6">VIEW NORE</button>
            ...
            <div className="grid mb-6">
                ...
                <button className="BTN bg-black text-white mt-16 font-semibold py-4 px-20 flex z-50 hover:border-2 hover:bg-transparent hover:text-black hover:border-black hover:py-4 hover:px-20 block mx-auto">GO TO LOOKBOOK&nbsp;&nbsp;&nbsp;<span className="my-auto text-2xl font-thin"><BsArrowRight /></span></button>
            </div>
            <div className="my-8">
                ...
                <div className="grid grid-cols-3 mx-32 my-24 AK gap-6">
                    ...
                    <img src="/12.jpg" alt="Loading..." className=""/>
                        <figcaption>
                            ...
                            <p className=" whitespace-nowrap font-thin text-sm uppercase"><a href="/">Read More</a></p>
