        ...
        <>
            <div className="">
                <div className="GP grid grid-cols-2 my-12 mx-32 gap-12">
                    <div className="img">
                        <img src="/sh16.jpg" alt="Loading..." className="SIZ"/>
                    </div>
                    <div className="text ml-12">
                        <div className="toggle p-4 rounded-full shadow-lg w-12 fixed ml">
                            <a href="/"><FaAngleRight className="text-black font-thin"/></a>
                        </div>
                        <div className="toggle p-4 rounded-full shadow-lg w-12 fixed MR mt-32">
                            <a href="./Cloth15"><FaAngleLeft className="text-black font-thin"/></a>
                        </div>
                        <nav className="flex">
