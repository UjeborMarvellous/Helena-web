        ...
        <>
            <div className="">
                <div className="GP grid grid-cols-2 my-12 mx-32 gap-12">
                    <div className="img">
                        <img src="/sh11.jpg" alt="Loading..." className="SIZE object-contain"/>
                    </div>
                    <div className="text ml-12">
                        <div className="toggle p-4 rounded-full shadow-lg w-12 fixed ml">
                            <Link href="./furniture12"><FaAngleRight className="text-black font-thin"/></Link>
                        </div>
                        <div className="toggle p-4 rounded-full shadow-lg w-12 fixed MR mt-32">
                            <Link href="./furniture10"><FaAngleLeft className="text-black font-thin"/></Link>
                        </div>
                        <nav className="flex">
