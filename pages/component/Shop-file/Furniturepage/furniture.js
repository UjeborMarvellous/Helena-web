        ...
        <>
            <div className="">
                <div className="GP grid grid-cols-2 my-12 mx-32 gap-12">
                    <div className="img">
                        <img src="/sh1.jpg" alt="Loading..." className="Ige"/>
                    </div>
                    <div className="text ml-12">
                        <div className="toggle p-4 rounded-full shadow-lg w-12 fixed ml">
                            <Link href="./furniture2"><FaAngleRight className="text-black font-thin"/></Link>
                        </div>
                        <nav className="flex">
                ...
                <div className="gids mt-12 mx-24">
                    ...
                    <div className="grid grid-cols-5 gra mb-16 pb-4">
                        <figure className="">
                            <img src="/sh2.jpg" alt="Loading..." className="h-72"/>
                            <figcaption>
                        ...
                        <figure className="">
                            <img src="/sh3.jpg" alt="Loading..." className="h-72"/>
                            <figcaption>
                                <p className="text-center">Regular Fit V-Neck Sweater</p>
                                <p className="text-center">$49.00</p>
                            </figcaption>
                        ...
                        <figure className="">
                            <img src="/sh4.jpg" alt="Loading..." className="h-72"/>
                            <figcaption>
                                <p className="text-center">Regular Fit V-Neck Sweater</p>
                                <p className="text-center">$49.00</p>
                            </figcaption>
                        ...
                        <figure className="off">
                            <img src="/sh7.jpg" alt="Loading..." className="h-72"/>
                            <figcaption>
                                <p className="text-center">Regular Fit V-Neck Sweater</p>
                                <p className="text-center">$49.00</p>
                            </figcaption>
