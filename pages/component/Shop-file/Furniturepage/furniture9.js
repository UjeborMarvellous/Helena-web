        ...
        <>
            <div className="">
                <div className="GP grid grid-cols-2 my-12 mx-32 gap-12">
                    <div className="img">
                        <img src="/sh9.jpg" alt="Loading..." className="SIZ object-contain"/>
                    </div>
                    <div className="text ml-12">
                        <div className="toggle p-4 rounded-full shadow-lg w-12 fixed ml">
                            <Link href="./furniture10"><FaAngleRight className="text-black font-thin"/></Link>
                        </div>
                        <div className="toggle p-4 rounded-full shadow-lg w-12 fixed MR mt-32">
                            <Link href="./furniture8"><FaAngleLeft className="text-black font-thin"/></Link>
                        </div>
                        <nav className="flex">
                    ...
                    <div className="grid grid-cols-2 gap-2 GB">
                        <div className="">
                            ...
                            <div className="Thrid flex">
                                <Link href="/" className="text-3xl ml-10 mt-8 text-white"><FaFacebookF /></Link>
                                <Link href="/" className="text-3xl ml-10 mt-8 text-white"><BsTwitter /></Link>
                                <Link href="/" className="text-3xl ml-10 mt-8 text-white"><FaWhatsapp /></Link>
                                <Link href="/" className="text-3xl ml-10 mt-8 text-white"><SiInstagram /></Link>
                            </div>
                        ...
                        <div className="two ml-auto">
                            <div className="Sec sm:flex FLEX">
                                <p className="mt-2"><Link href="/" className="mt-12 text-white whitespace-nowrap">Terms & Policies&nbsp;/&nbsp;</Link></p>
                                <p className="mt-2"><Link href="/" className="mt-12 text-white whitespace-nowrap">FAQ&nbsp;/&nbsp;</Link></p>
                                <p className="mt-2"><Link href="/" className="mt-12 text-white whitespace-nowrap">Contact Us&nbsp;/&nbsp;</Link></p>
                                <p className="mt-2"><Link href="/" className="mt-12 text-white whitespace-nowrap">About Us</Link></p>
                            </div>
