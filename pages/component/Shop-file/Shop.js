...
import Furniture from "../Image/Furniture";
    ...
    return ( 
        <div className="" data-aos="fade-up">
            ...
            <body>
                    ...
                    <div className="grid grid-cols-6 g mt-12 mx-12 MX">
                        <div className="one">
                            ...
                            <div className="input">
                                ...
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><Link href="/" className="text-sm">&nbsp;&nbsp;Pillow Cassing</Link><span className="ml-20 text-gray-300 font-bold">(4)</span></p>
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><Link href="/" className="text-sm">&nbsp;&nbsp;Kitchen</Link><span className="ml-24 text-gray-300 font-bold">(3)</span></p>
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><Link href="/" className="text-sm">&nbsp;&nbsp;Dining Set</Link><span className="ml-24 text-gray-300 font-bold">(2)</span></p>
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><Link href="/" className="text-sm">&nbsp;&nbsp;Plastics</Link><span className="ml-24 text-gray-300 font-bold">(4)</span></p>
                            </div>
                            <hr  className="my-6"/>
                    ...
                    <Transition show={open} className="" enter="transition ease-out duration-100 transform" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="transition ease-in duration-75 transform" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                            {(ref) => (
                                ...
                                <div className="hs ml-12">
                                    <select name="Clothes" className="bg-none focus:outline-none border-none p">
                                ...
                                <div className="As flex mx-auto ">
                                    <Link href="/component/Shop-file/Shop" className="text-sm font-thin">1&nbsp;&nbsp;/&nbsp;&nbsp;</Link>
                                    <Link href="/2" className="text-sm font-thin">2&nbsp;&nbsp;/&nbsp;&nbsp;</Link>
                            ...
                            <div className="lg:mx-0 sm:mx-4 mx-8">
                                <Furniture />
                            </div>
                ...
                <div hidden id="snipcart" data-api-key="YzFkOTM2OTktNzM4NS00YzM5LWEwZTktOTM5Mjc5ZmZjYWI1NjM3OTA0NzQ3MTE5MjI2OTU3" data-config-modal-style="side"></div>
            </body>
        </div>
     );
}
