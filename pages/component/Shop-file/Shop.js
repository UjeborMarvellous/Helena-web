                    ...
                    <div className="grid grid-cols-6 g mt-12 mx-12 MX">
                        <div className="one">
                            ...
                            <div className="input">
                                ...
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><a href="/" className="text-sm">&nbsp;&nbsp;Pillow Cassing</a><span className="ml-20 text-gray-300 font-bold">(4)</span></p>
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><a href="/" className="text-sm">&nbsp;&nbsp;Kitchen</a><span className="ml-24 text-gray-300 font-bold">(3)</span></p>
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><a href="/" className="text-sm">&nbsp;&nbsp;Dining Set</a><span className="ml-24 text-gray-300 font-bold">(2)</span></p>
                                <p className=" mt-3 ml-6 whitespace-nowrap"><input type="checkbox" /><a href="/" className="text-sm">&nbsp;&nbsp;Plastics</a><span className="ml-24 text-gray-300 font-bold">(4)</span></p>
                            </div>
                            <hr  className="my-6"/>
                    ...
                    <Transition show={open} className="" enter="transition ease-out duration-100 transform" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="transition ease-in duration-75 transform" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                            {(ref) => (
                                ...
                                <div className="As flex mx-auto ">
                                    <a href="/component/Shop-file/Shop" className="text-sm font-thin">1&nbsp;&nbsp;/&nbsp;&nbsp;</a>
                                    <a href="/2" className="text-sm font-thin">2&nbsp;&nbsp;/&nbsp;&nbsp;</a>
