            ...
            <div className="">
                    ...
                    <Transition show={open} className="" enter="transition ease-out duration-100 transform" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="transition ease-in duration-75 transform" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                            ...
                            <div className="imgs grid grid-cols-4 mx-16 GRA">
                                <figure>
                                    <Link href=""><img src="/S-blue1.jpg" alt="Loading..." className="h-96 W object-contain"/></Link>
                                    <figcaption>
                                ...
                                <figure>
                                    <Link href=""><img src="/S-blue2.jpg" alt="Loading..." className="h-96 W object-contain"/></Link>
                                    <figcaption>
                                        <p className="text-center">Regular Fit V-Neck Sweater</p>
                                        <p className="text-center">$49.00</p>
                                    </figcaption>
                                ...
                                <figure>
                                    <Link href=""><img src="/S-blue3.jpg" alt="Loading..." className="h-96 W object-contain"/></Link>
                                    <figcaption>
                                        <p className="text-center">Regular Fit V-Neck Sweater</p>
                                        <p className="text-center">$49.00</p>
                                    </figcaption>
                                ...
                                <figure>
                                    <Link href=""><img src="/S-blue4.jpg" alt="Loading..." className="h-96 W object-contain"/></Link>
                                    <figcaption>
                                        <p className="text-center">Regular Fit V-Neck Sweater</p>
                                        <p className="text-center">$49.00</p>
                                    </figcaption>
                                ...
                                <figure>
                                    <Link href=""><img src="/S-blue5.jpg" alt="Loading..." className="h-96 W object-contain"/></Link>
                                    <figcaption>
                                        <p className="text-center">Regular Fit V-Neck Sweater</p>
                                        <p className="text-center">$49.00</p>
                                    </figcaption>
